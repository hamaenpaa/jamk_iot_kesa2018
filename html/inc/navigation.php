...
$pages = array("list_courses","list_nfc_tags","list_rooms","list_teachers","list_students","list_guests","logout");	
$pages_title = 	array("Logout","Courses","NFC Tags","Rooms","Teachers","Students","Guests","Logout");
$pageAM = count($pages);
