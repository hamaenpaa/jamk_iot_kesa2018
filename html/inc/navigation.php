...
<ul id="mobile_links">
<?php
$pages = array("index.php","index.php?screen=1","index.php?screen=2","index.php?screen=3","index.php?screen=4");	
$pages_title = 	array("Huoneloki","Koulutukset/oppitunnit","Kurssit","Käyttäjät",$login_logout_text);
$pageAM = count($pages);
for ($i=0;$i<$pageAM;$i++) {
