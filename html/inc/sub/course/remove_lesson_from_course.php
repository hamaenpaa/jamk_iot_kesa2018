<?php
	...
	$seek_params_get .= possible_get_param("page_lesson_add",$page_lesson_add, false);
	$seek_params_get .= possible_get_param("page_lesson_add_page", $page_lesson_add_page, false);		
